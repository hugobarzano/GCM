...
En las siguientes secciones se presenta a modo de introducción conceptos relativos a Programación Generativa, La Nube y procesos relacionados con el ciclo de vida de los proyectos software como la Integración Continua y el Despliegue Continuo, se pretende con esto dotar al lector de un contexto o conocimiento básico para abordar el proyecto.
...
De manera adicional, este proyecto tiene como objetivo presentar mejoras y automatizaciones relativas a los proceso de desarrollo software. El sistema resultante se presenta como una herramienta o ayuda para desarrolladores o clientes en la adquisición de conocimientos  en las denominadas tecnologías de la información.  
