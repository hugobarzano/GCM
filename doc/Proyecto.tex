...
Infraestructura Virtual de las Aplicaciones se profundiza y justifica el uso de esta tecnología para cumplir con el objetivo de desplegar y disponibilizar las aplicaciones generadas a través de Internet. 
...
\subsection{En el Mercado}

Actualmente en el mercado existen soluciones cloud que ofrecen parte de la funcionalidad que este proyecto intenta cubrir, las mas destacadas son: 
...
Para mostrar las capacidades del sistema software GCM:Code-Runner se presenta el siguiente caso de uso desglosado en las distintas operaciones que un usuario final es capaz de realizar sobre el sistema. 
