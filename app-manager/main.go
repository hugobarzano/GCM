...
import (
	...
	"net/http"
	"os"
	google "github.com/google/go-github/github"
...
func issueSession() http.Handler {
	fn := func(w http.ResponseWriter, req *http.Request) {
		...
		client := google.NewClient(tc)

		r := &google.Repository{Name: google.String("generated-repo-static1"),
			Private: google.Bool(false), Description: google.String("des")}
